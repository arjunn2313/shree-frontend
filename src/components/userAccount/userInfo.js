...
export default function UserInfo() {
  ...
  const handleOtp = () => {
    ...
    if (Object.keys(error).length > 0) {
      ...
      setErrors("");
      axios
        .post(`${api}/user/otp`, { phone: userDetails.phone })
        .then((res) => {
        ...
        <>
          <div className="container py-5 mt-5 rounded-3 create-account">
            ...
            <div className="row px-2 px-md-4 pt-3">
              ...
              <div className="col-12 col-md-5 d-flex flex-column justify-content-center align-items-start mb-3">
                <label className="form-label mb-2 mb-md-3 fs-6 fw-medium">
                ...
                <label className="form-label mb-2 mb-md-3 fs-5 fw-medium">
