    ...
    <div className="footer">
      <div className="footer-child1 row">
        <div className="footer-title col-12 col-md-6">
          <img src="assets\Untitled-1-01 1.png" className="img-fluid"/>
          <p>
        ...
        <div className="col-4 col-md-2">
          <h6>About</h6>
          <ul className="list-unstyled pt-4 d-flex flex-column gap-3 footer-list">
          <Link to='/'>
            <li>Home</li>
            </Link>
        ...
        <div className="contact-num col-4 col-md-2">
            ...
            <div className="d-flex gap-4 footer-icon pt-4">
            <FaSquareInstagram/>
            <FaLinkedin/>
            <FaSquareFacebook/>
            <FaTwitterSquare/>
      ...
      <div className="footer-child-2">
         <div>
         © Copyright 2023 kevins.com , All rights reserved.
         </div>
         <div>
